...
dl <- drive_download(file = "Skagit County/Skagit.xlsx", # google drive filename
                     path = "County-SO-Data/Skagit/Skagit.xlsx", # local filename
                     overwrite = TRUE, 
                     type = "xlsx")
...
skagit.inci <- read_xlsx("County-SO-Data/Skagit/Skagit.xlsx")
