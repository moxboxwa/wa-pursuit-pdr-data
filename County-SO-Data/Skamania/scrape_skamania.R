...
dl <- drive_download(file = "Skamania County/Skamania.xlsx", # google drive filename
                     path = "County-SO-Data/Skamania/Skamania.xlsx", # local filename
                     overwrite = TRUE, 
                     type = "xlsx")
...
skamania.inci <- read_xlsx("County-SO-Data/Skamania/Skamania.xlsx")

skamania.tbl <- read_xlsx(
  "County-SO-Data/Skamania/Skamania.xlsx",
  sheet = "Table",
  skip = 2
)

save.image(file="County-SO-Data/Skamania/Skamania.rda")
