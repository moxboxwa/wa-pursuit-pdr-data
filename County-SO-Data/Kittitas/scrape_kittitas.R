...
dl <- drive_download(file = "Kittitas County/Kittitas.xlsx", # google drive filename
                     path = "County-SO-Data/Kittitas/Kittitas.xlsx", # local filename
                     overwrite = TRUE, 
                     type = "xlsx")
...
kittitas.inci <- read_xlsx("County-SO-Data/Kittitas/Kittitas.xlsx")
