...
dl <- drive_download(file = "Okanagan County/Okanagan.xlsx", # google drive filename
                     path = "County-SO-Data/Okanagan/Okanagan.xlsx", # local filename
                     overwrite = TRUE, 
                     type = "xlsx")
...
okanagan.inci <- read_xlsx("County-SO-Data/Okanagan/Okanagan.xlsx")

okanagan.tbl <- read_xlsx(
  "County-SO-Data/Okanagan/Okanagan.xlsx",
  sheet = "Table",
  skip = 2
)

save.image(file="County-SO-Data/Okanagan/Okanagan.rda")
